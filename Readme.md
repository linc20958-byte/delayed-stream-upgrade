...
This package is an actively maintained fork of [felixge/node-delayed-stream](https://github.com/felixge/node-delayed-stream) (`delayed-stream` on npm): same runtime API, modern tooling (Node 18+ built-in test runner, zero dependencies, clean `npm audit`), and a current semver line for security review pipelines.
